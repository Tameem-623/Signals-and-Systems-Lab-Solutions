...
bk(11) = 2 * T1 / T; % Manual correction for b0 ?> bk(51)
...
xlabel('t');
ylabel('x(t)+y(t)');
title('original x(t)+y(t) with ak''s and bk''s with 21 terms');
grid;
figure(2);
plot(t, real(zt), 'lineWidth', 2);
xlabel('t');
ylabel('z(t)=x(t)+y(t)');
title('Reconstruction of y(t)from ak+bk''s with 21 terms');
grid;
